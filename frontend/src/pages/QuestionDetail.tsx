...
function ConfirmDeleteModal({ questionId, onCancel, onConfirmed }: ConfirmDeleteModalProps) {
  ...
  return (
    ...
    >
      <div className="bg-dm-card border border-dm-border rounded-xl shadow-2xl w-full max-w-sm mx-4 p-6">
        {/* Icon */}
        <div className="flex items-center justify-center w-12 h-12 rounded-full bg-red-900/30 border border-red-800/40 mx-auto mb-4">
        ...
        <h2 className="text-sm font-semibold text-dm-text text-center mb-1">Delete Question #{questionId}?</h2>
        <p className="text-xs text-dm-text2 text-center leading-relaxed mb-5">
          This will permanently delete the question along with all its images and video. This action cannot be undone.
        </p>

        {error && (
          <p className="text-xs text-red-400 bg-red-900/20 border border-red-800/30 rounded-md px-3 py-2 mb-4 text-center">
            {error}
          </p>
        )}
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            disabled={deleting}
            className="flex-1 text-xs py-2 rounded-md font-medium bg-red-700 hover:bg-red-600 active:bg-red-800 text-white transition-colors duration-150 disabled:opacity-50 flex items-center justify-center gap-2"
          >
            {deleting && (
    ...
    <Layout>
        ...
        <div className="flex items-center justify-between mb-5">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-1.5 text-xs py-1.5 px-3 rounded-md font-medium border border-red-800/50 text-red-400 hover:bg-red-900/20 hover:border-red-700/60 transition-colors duration-150"
            >
              <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
              </svg>
      ...
      {showDeleteModal && (
        <ConfirmDeleteModal
          ...
          onConfirmed={() => navigate('/questions', { replace: true })}
        />
      )}
    </Layout>
  )
